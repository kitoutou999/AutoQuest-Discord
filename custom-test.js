(function() {
    ...
    class BurgerMenu {
        ...
        createMenu() {
            ...
            menuItems.forEach(item => {
                ...
                menuItem.addEventListener('click', (e) => {
                    ...
                    if (item.action === 'home') {
                        //this.showCustomHome();
                        this.buildCustomPage('Accueil','https://example.com/icon.png');
                    } else if (item.action === 'questAutoComplete') {
        ...
        buildCustomPage(title,iconUrl,htmlcontent) {
            ...
            const navBar = pageChild.firstChild;
            const upperContainer = navBar.querySelector('div[class*="upperContainer"]');

            while (pageChild.children.length > 1) {
                pageChild.removeChild(pageChild.lastChild);
            }


            

            const toolbar = upperContainer.querySelector('div[class*="toolbar"]');
            const icon = upperContainer.querySelector('img[class*="icon"]');
            const titleElement = upperContainer.querySelector('h1[class*="title"]');
            const dot = upperContainer.querySelector('svg[class*="dot"]');
            const tabList = upperContainer.querySelector('div[class*="topPill"]');
            ...
            const bgColor = computedStyle.backgroundColor || computedStyle.background || 'rgb(26, 26, 30)';
